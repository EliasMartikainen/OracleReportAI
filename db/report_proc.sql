-- ============================================
-- OracleReportAI - Raporttiproseduurit
-- Jankon Betoni Oy
-- ============================================
...
CREATE OR REPLACE PACKAGE BODY report_pkg AS
    ...
    PROCEDURE get_vuosiraportti(
        ...
        v_q4                NUMBER;
    BEGIN
        -- Kokonaismyynti ja kappaleet
        SELECT 
            SUM(maara * yksikkohinta),
            COUNT(*)
        ...
        -- Kvartaalikohtaiset myynnit
        SELECT NVL(SUM(CASE WHEN EXTRACT(MONTH FROM myyntipaiva) BETWEEN 1 AND 3 
